...
export function Footer() {
  return (
    <footer className="footerbg relative z-10 overflow-x-hidden pb-5 pl-3 pt-6 lg:py-2 lg:pl-0">
      <div className="container mx-auto text-white">
        <div className="mx-auto grid max-w-4xl pt-10 sm:grid-cols-1 md:grid-cols-3">
